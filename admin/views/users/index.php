<?php $pageTitle = 'Users'; require BASE_PATH . '/admin/views/layout/header.php'; ?>
<form method="GET" class="filter-bar">
  ...
  <div style="min-width:120px">
    ...
    <select name="plan" class="form-select"><option value="">All Paid</option>
  ...
  <div class="d-flex gap-2 align-self-end">
    ...
    <a href="<?= BASE_URL ?>/admin/users" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i></a>
  </div>
</form>

<div class="card">
  <div class="ch d-flex justify-content-between align-items-center">
    <span><i class="bi bi-people me-2"></i>Paid Users <span class="badge bg-white text-dark ms-1"><?= $pager['total'] ?></span></span>
  ...
  <div class="card-body p-0">
    <div class="table-responsive">
      <table class="table table-hover align-middle mb-0">
        <thead><tr><th>#</th><th>Name</th><th>User Plan</th><th>Phone</th><th>City</th><th>Expires</th><th>Status</th><th>Actions</th></tr></thead>
        <tbody>
        <?php if(empty($pager['data'])): ?>
          <tr><td colspan="8" class="text-center py-5 text-muted"><i class="bi bi-inbox fs-2 d-block mb-2"></i>No paid users found.</td></tr>
        ...
        <tr>
          ...
          <td>
            ...
            <?php if($u['profession']): ?><div class="small text-muted"><?= htmlspecialchars($u['profession']) ?></div><?php endif ?>
          </td>
          <td>
          ...
          <td class="small"><?= $u['plan_expires_at'] ? Helper::formatDate($u['plan_expires_at']) : '—' ?></td>
          ...
          <td>
            <div class="d-flex gap-1">
              ...
              <form method="POST" action="<?= BASE_URL ?>/admin/users/toggle">
                ...
                <input type="hidden" name="back" value="<?= BASE_URL ?>/admin/users">
  ...
  <div class="card-footer" style="background:#f8f7ff">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
      <small class="text-muted"><?= $pager['total'] ?> total</small>
      <?= Helper::paginationLinks($pager, BASE_URL.'/admin/users?'.http_build_query(array_filter($filters))) ?>
    </div>
  </div>
  <?php endif ?>
</div>
